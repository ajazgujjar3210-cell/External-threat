"""
Django settings for EASM Platform.
"""
import os
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-change-this-in-production-easm-platform')
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 5,  # Changed to 5 assets per page as requested
